//
//  CalculatorRepositoryBaby.swift
//  ProyectoTwitter
//
...
class CalculatorRepositoryBaby {
    ...
    static public func index(completion : @escaping indexCompletion ) -> Void {
        ApiHelperBaby.request(endpoint: .GetIndexImages) { data, err, response in
            print("se va al andlere")
            CalculatorRepositoryBaby.handleResponseIndex(data: data, completion: completion)
        }
    }
